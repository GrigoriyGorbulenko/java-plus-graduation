...
public class EventMapper {
    ...
    public EventFullDto mapToFullDto(Event event, Long views, UserDto userDto, CategoryDto categoryDto) {
    ...
    public EventShortDto mapToShortDto(Event event, Long views, UserDto userDto, CategoryDto categoryDto) {
